...
function buildHelpText() {
  return [
    ...
    '  xt maraca build app.rmt --orchestration strict --kernel strict --hydration strict --validation strict --transitions strict --out dist --profile production --lazy route --css external --json',
  ...
  if (command === 'maraca') {
    ...
    if (subcommand === 'help' || options.help) {
      writeLine(stdout, [
        ...
        'Usage:',
        '  xt maraca plan app.rmt --orchestration strict --kernel strict --hydration strict --validation strict --transitions strict --json',
        '  xt maraca build app.rmt --orchestration strict --kernel strict --hydration strict --validation strict --transitions strict --out dist --profile production --lazy route --css inline --json',
        '  xt maraca build app.rmt --vendor xtend --out products/xtend-vendor-maraca --lazy none --json',
        '',
        'Commands:',
