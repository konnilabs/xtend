...
|------------|----------------|---------------------|--------|------------------|--------------------|-----------|----------------|-------|--------------|
| `NFM-HO-01` | `native-primitives-first` | `NFM-WP-01`, `NFM-WP-02`, `NFM-WP-03`, `NFM-WP-18`, `NFM-WP-19` | `accepted` | `accepted` | `native-primitive-radar-cadence` | `browser-lab-cadence` | `contract-registry`, `contract-runtime-parity`, `rmt-renderer-dom-descriptor-proofs`, `native-first-budget-gates`, `references` | `browser-primitive-owner` | `native-primitive-review-cadence` |
...
|------------|------------------|
| `NFM-HO-01` | `xtend.native-first.mission-source-of-truth.v1`, `xtend.native-first.browser-primitive-radar.v1`, `xtend.native-first.primitive-adoption-gate.v1`, `xtend.native-first.rmt-renderer-dom-descriptor-proofs.v1`, `xtend.native-first.performance-complexity-bundle-budget-gates.v1` |
