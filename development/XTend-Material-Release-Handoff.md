...
| `@ccslabs/xtend` | `0.8.0` Peer von Core, synchron zur XTend-Release-Version | Component-/Token-Verträge bleiben upstream-owned |
| `@ccslabs/xtend-maraca` | `0.8.0` Peer des Adapters, synchron zur XTend-Release-Version | CSS Provider Contract bleibt generisch |
