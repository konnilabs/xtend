...
| `development/XTend-Native-First-Browser-Primitive-Radar.md` | `NFM-BPR-001` bis `NFM-BPR-024` terminal aufgeloest |
...
| `NFM-CAP-04` | Forms, Validation und Input Composition | `owned-native-backed` | `ready-with-terminal-radar-decision` | `x-input`, `x-select`, `x-checkbox`, `x-radio`, `x-textarea`, `x-calendar`, `x-form`, `x-writer`, `NFM-WP-08` hardening matrix | `NFM-BPR-003`, `NFM-BPR-004` | ElementInternals, Constraint Validation und FormData sind mit XTend-Wrappern und Fallbacks akzeptiert | Hygiene-Review am 3. Dezember 2026 |
...
| `NFM-CAP-06` | Overlay, Dialog, Popover, Drawer und Focus | `owned-native-backed` | `ready-with-terminal-radar-decision` | `x-modal`, `x-dialog`, `x-popover`, `x-tooltip`, `x-drawer`, overlay bridge, `NFM-WP-07` hardening matrix | `NFM-BPR-005`, `NFM-BPR-006`, `NFM-BPR-007`, `NFM-BPR-008`, `NFM-BPR-016`, `NFM-BPR-020` | owned Overlay-/Focus-Pfad ist durch `NFM-WP-07` gehaertet; `inert` bleibt gewrappt; native Dialog-, Popover- und Anchor-Uebernahme ist terminal abgelehnt | keine aktive Radar-Folgearbeit |
...
| `NFM-CAP-09` | Layout, Display und Content Surfaces | `owned-native-backed` | `ready-with-terminal-radar-decision` | `x-section`, `x-cards`, `x-header`, `x-footer`, `x-hero`, `x-type`, `x-masonry`, `x-summary`, `NFM-WP-08` hardening matrix | `NFM-BPR-009`, `NFM-BPR-013`, `NFM-BPR-020` | Container Queries sind akzeptiert; Data Display wird nicht behauptet | Hygiene-Review am 3. Dezember 2026 |
| `NFM-CAP-10` | Media Shells und Rich Media | `owned-native-backed` | `ready-with-terminal-radar-decision` | `x-player`, `x-lightbox`, `NFM-WP-08` hardening matrix | `NFM-BPR-018`, `NFM-BPR-010` | PiP ist capability-gated akzeptiert; Media Session ist terminal abgelehnt | Hygiene-Review am 3. Dezember 2026 |
...
| Native Dialog/Popover/Anchor-Uebernahme | kein offenes Radar-Risiko | terminal `reject-for-now`; owned Pfad bleibt fuehrend |
