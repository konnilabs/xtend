...
| `xtend.native-first.browser-primitive-radar.v1` | `accepted` | `browser-primitive-owner` | `NFM-WP-02` | `Phase 1` | `xtend.native-first.browser-primitive-radar-report.v1` | `browser-primitive-radar` | `development/XTend-Native-First-Browser-Primitive-Radar-Contract.md` | `browser-primitive-radar` | `native-first` | `source-contract` | Primitive Radar fuer Adoption-Evidence |
| `xtend.native-first.primitive-adoption-gate.v1` | `accepted` | `architecture-governance-owner` | `NFM-WP-03` | `Phase 1` | `xtend.native-first.primitive-adoption-gate-report.v1` | `primitive-adoption-gate` | `development/XTend-Native-Primitive-Adoption-Gate-Contract.md` | `primitive-adoption-gate` | `native-first` | `gate-plan` | ADR- und Adoption-Gate |
...
|--------------|--------------------------|---------------|
| `drift-missing-contract-reference` | `none-known` fuer Native-First-Contracts `NFM-WP-01` bis `NFM-WP-13`; `NFM-WP-14` ist als RMT UI Primitive Gap Contract registriert; `NFM-WP-15` ist als RMT Syntax Growth Contract registriert; `NFM-WP-16` ist als RMT Action Effect Data Resource Primitives Contract registriert; `NFM-WP-17` ist als RMT Complete UI Recipe Fixtures Contract registriert; `NFM-WP-18` ist als RMT Renderer DOM Descriptor Proofs Contract registriert; `NFM-WP-19` ist als Native-First Budget Gates Contract registriert; `NFM-WP-20` ist als Docs Authoring Guides Contract registriert; `NFM-WP-21` ist als Migration Deprecation Plan Contract registriert; `NFM-WP-22` ist als Mission Handoff Contract registriert | blockierend |
