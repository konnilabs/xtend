...
| `xtend.native-first.observatory-intake.v1` | `accepted-internal-intake` | `architecture-governance-owner` | `OBS-2026-08-17` | `Continuous Review` | `xtend.native-first.browser-primitive-radar-report.v1` | `browser-primitive-radar` | `development/XTend-Native-First-Feature-Adoption-Observatory-Contract.md` | `feature-adoption-observatory` | `native-first` | `source-contract` | Untrusted KI-Intake, Review-Ledger, Labs und Adoption-ADR-Grenze |
...
|--------------|--------------------------|---------------|
| `drift-missing-contract-reference` | `none-known` fuer Native-First-Contracts `NFM-WP-01` bis `NFM-WP-13`; `NFM-WP-14` bis `NFM-WP-22` und das kontinuierliche Feature Adoption Observatory `OBS-2026-08-17` sind registriert | blockierend |
