...
| `NFM-AEP-13` | `release-pack` | `xtend.epic13.rc1-gate-matrix-ci-handoff.v1` | `release-owner` | `epic13-rc1-gate-matrix-ci-handoff` | `xtend.epic13.rc1-gate-matrix-ci-handoff-report.v1` | `development/XTend-Epic13-RC1-Gate-Matrix-und-CI-Handoff.md`, `docs/en/release-verification.md`, `catalog/epic13-rc1-gate-matrix-ci-handoff.js`, `.xtend-test-results/xtend-epic13-rc1-gate-matrix-ci-handoff-report.json` | `release-owner-review-ready` | `release-evidence` | RC1-Gate-Matrix, CI-Lanes und Owner-Handoff bewerten | `publish bleibt private bis Owner Acceptance` | `NFM-WP-22` |
