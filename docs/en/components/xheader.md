...
App headers, navigation and global actions.

## When to use it

x-header is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
