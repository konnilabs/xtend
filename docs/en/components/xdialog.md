...
Confirmations and focused dialogs.

## When to use it

x-dialog is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
