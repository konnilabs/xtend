...
Form layout, validation and submission context.

## When to use it

x-form is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
