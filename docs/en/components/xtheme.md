...
Theme packs, tokens and color mode.

## When to use it

x-theme is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
