...
Modal overlays with focus and inert behavior.

## When to use it

x-modal is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
