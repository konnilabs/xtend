...
Semantic content sections and layout.

## When to use it

x-section is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
