...
Code blocks, snippets and syntax highlighting.

## When to use it

x-code is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
