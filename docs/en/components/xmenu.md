...
Menus, actions and keyboard navigation.

## When to use it

x-menu is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
