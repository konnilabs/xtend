...
Coordination of managed surfaces.

## When to use it

x-surface-manager is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
