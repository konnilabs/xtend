...
Select boxes and compact option fields.

## When to use it

x-select is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
