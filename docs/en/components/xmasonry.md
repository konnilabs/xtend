...
Responsive tile and gallery layouts.

## When to use it

x-masonry is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
