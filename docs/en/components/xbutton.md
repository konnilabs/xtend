...
Actions, form triggers and icon buttons.

## When to use it

x-button is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
