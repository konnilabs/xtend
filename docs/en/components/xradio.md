...
Single choice in forms.

## When to use it

x-radio is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
