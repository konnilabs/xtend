...
Multiple choice and boolean settings.

## When to use it

x-checkbox is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
