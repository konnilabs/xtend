...
Product, app and documentation footers.

## When to use it

x-footer is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
