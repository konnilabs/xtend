...
Audio, video and tutorial media.

## When to use it

x-player is part of the public XTend component library. Use it when you need a local, themeable Web Component without a framework binding.
