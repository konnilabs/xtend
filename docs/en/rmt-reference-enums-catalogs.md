...
| <a id="transition-effects"></a>Transition effects | `fade`, `crossfade`, `slide-left`, `slide-right`, `slide-up`, `slide-down`, `scale`, `none` | `transition effect` | identifier | Selects visual surface transition. | Unknown effects can be catalog diagnostics. | `transition` |
