...
Mehrfachauswahl und boolesche Einstellungen.

## Wann einsetzen

x-checkbox ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
