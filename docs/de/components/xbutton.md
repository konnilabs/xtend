...
Aktionen, Formularauslöser und Icon-Buttons.

## Wann einsetzen

x-button ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
