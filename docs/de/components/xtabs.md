...
Tab-Navigation und Panel-Wechsel.

## Wann einsetzen

x-tabs ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
