...
Text-, Such- und numerische Eingaben.

## Wann einsetzen

x-input ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
