...
Audio-, Video- und Tutorial-Medien.

## Wann einsetzen

x-player ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
