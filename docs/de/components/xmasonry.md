...
Responsive Kachel- und Galerie-Layouts.

## Wann einsetzen

x-masonry ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
