...
Codeblöcke, Snippets und Syntax-Hervorhebung.

## Wann einsetzen

x-code ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
