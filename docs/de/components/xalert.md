...
Feedback-Hinweise und Statusmeldungen.

## Wann einsetzen

x-alert ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
