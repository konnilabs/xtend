...
App Header, Navigation und globale Aktionen.

## Wann einsetzen

x-header ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
