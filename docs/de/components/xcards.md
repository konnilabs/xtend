...
Kompakte Inhaltsgruppen und Listen.

## Wann einsetzen

x-cards ist Teil der öffentlichen XTend Komponentenbibliothek. Nutze die Komponente, wenn du eine lokale, themenfähige Web-Component ohne Framework-Bindung brauchst.
