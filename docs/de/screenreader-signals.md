...
Screenreader Signals ist der öffentliche Qualität und Security-Vertrag für `docs/de/screenreader-signals.md`. Stabil ist nicht die Textlänge, sondern ob ein externer Host die genannten Dateien, Namen und Prüfungen ohne internes Projektwissen nachvollziehen kann.
...
Quellen:
- `docs/de/screenreader-signals.md`
- `docs/menu.json`
- `package.json`
