...
RMT State Selector Runtime beschreibt die öffentliche RMT-Oberfläche dieser Seite: welche Records betroffen sind, welche Adapter sie ausüben und welche Scheduler-Signale ein Host prüfen sollte.
...
RMT State Selector Runtime ist der öffentliche RMT Runtime-Vertrag für `docs/de/rmt-state-selector-runtime.md`. Stabil ist nicht die Textlänge, sondern ob ein externer Host die genannten Dateien, Namen und Prüfungen ohne internes Projektwissen nachvollziehen kann.
...
Quellen:
- `docs/de/rmt-state-selector-runtime.md`
- `docs/menu.json`
- `package.json`
