...
- `xtendrmt/rmt-state-binding-view-projector.js` projiziert eingefrorene Model-Snapshots über den gemeinsamen DOM-Renderer; die bisherigen Binding-Helfer bleiben als Kompatibilitätsdelegaten erhalten.
