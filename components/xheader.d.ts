...
export type XHeaderAttributeName = 'src' | 'logo-size' | 'title' | 'sticky' | 'shadow' | 'menu-mode' | 'menu-placement' | 'menu-modal' | 'menu-open' | 'menu-breakpoint' | 'menu-width' | 'menu-max-height' | 'menu-align';
export type XHeaderEventName = 'header-ready' | 'header-layout-changed' | 'menu-before-open' | 'menu-before-close' | 'menu-opened' | 'menu-closed' | 'menu-mode-changed' | 'menu-placement-changed' | 'logo-loaded';
