  ...
  constructor() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <label id="label" for="control">
        <input id="control" part="control" type="radio" role="radio" aria-describedby="hint error">
        <span><slot name="label"><span id="label-text"></span></slot><slot></slot></span>
      </label>
      <div id="hint" class="hint"><slot name="hint"></slot></div>
      <div id="error" class="error" role="alert" aria-live="assertive" aria-atomic="true"><slot name="error">Select an option.</slot></div>
    `;
