(function () {
  class XRmtLifecycleDemo extends HTMLElement {
    ...
    static get xtendScaffoldWiring() {
      return {
        ...
        stateKeys: ["xtend.component.x-rmt-lifecycle-demo.<id>.ready", "xtend.component.x-rmt-lifecycle-demo.<id>.value"],
        events: ["rmt-lifecycle-demo-ready", "rmt-lifecycle-demo-changed"],
        apiNamespaces: ["window.XTend.components['x-rmt-lifecycle-demo']"],
    ...
    static get xtendScaffoldExtensionPoints() {
      ...
      "rootLifecycle": {
            ...
            "rootRef": "rmt-lifecycle-demo.root.<id>",
            "componentRef": "rmt-lifecycle-demo.<id>",
            "templateRef": "rmt-lifecycle-demo.template",
            "host": "custom-element",
            ...
            "stateKeys": {
                  "lifecycle": "xtend.component.x-rmt-lifecycle-demo.<id>.lifecycle",
                  "hydration": "xtend.component.x-rmt-lifecycle-demo.<id>.hydration",
                  "diagnostics": "xtend.component.x-rmt-lifecycle-demo.<id>.diagnostics"
            },
      ...
      "schedulerHandshake": {
            ...
            "statePolicy": "digital-twin-ssot-xstate",
            "diagnosticsRef": "xtend.component.x-rmt-lifecycle-demo.<id>.diagnostics",
            "boundaries": {
                  "schedulerOwns": [
                        "schedule-selection",
                        "lane",
      ...
      "hostCapabilities": {
            ...
            "capabilities": {
                  ...
                  "stateBridge": {
                        ...
                        "canonicalPrefix": "xtend.component.x-rmt-lifecycle-demo.<id>.",
                        "stateKeys": [
                              "xtend.component.x-rmt-lifecycle-demo.<id>.ready",
                              "xtend.component.x-rmt-lifecycle-demo.<id>.value"
                        ],
                        "localUiPolicy": "derived-render-cache-only",
                        "forbidden": [
                              "direct-xstate-mutation-by-kernel",
                  ...
                  "api": {
                        ...
                        "namespaces": [
                              "window.XTend.components['x-rmt-lifecycle-demo']"
                        ],
                  ...
                  "diagnostics": {
                        ...
                        "optional": true,
                        "stateSnapshotKey": "xtend.component.x-rmt-lifecycle-demo.<id>.diagnostics",
                        "eventNamespace": "xtend.rmt.host.rmt-lifecycle-demo",
                        "reportToRmt": true,
      ...
      "rmtCompatibilityBinding": {
            ...
            "artifactBinding": {
                  "typing": "components/x-rmt-lifecycle-demo.d.ts",
                  "manifest": "components/manifest.json",
                  "preview": "docs/previews/rmt-lifecycle-demo.preview.md",
            ...
            "previewPlan": {
                  "schema": "xtend.scaffold.rmt-compatibility-binding.v1",
                  "previewRef": "docs/previews/rmt-lifecycle-demo.preview.md",
                  "localOnly": true,
    ...
    static get xtendScaffoldA11yProfile() {
      ...
      "accessibleName": {
            "source": "aria-label",
            "required": true,
            "defaultText": "XRmtLifecycleDemo component",
      ...
      "screenreader": {
            ...
            "signalContract": {
                  ...
                  "statusRegions": [
                        {
                              "id": "x-rmt-lifecycle-demo.state-change-summary.status-region",
  ...
  if (!customElements.get('x-rmt-lifecycle-demo')) {
    customElements.define('x-rmt-lifecycle-demo', XRmtLifecycleDemo);
  }
})();
