...
export interface PageClientOptions { transition?(update: () => Promise<void>): void | Promise<void>; initialPage: PageResponse; applicationKey?: string; onDownload?(result: PageDownload): void | Promise<void>; resume?: RmtResumeRuntimeOptions; links?: boolean; window?: Window; origin?: string; fetch?: typeof fetch; root?: Element; router?: {pageClient?: {visit(url: string): Promise<unknown>} | null}; headers?(): Record<string, string>; timeoutMs?: number; cacheSize?: number; maxConcurrentRequests?: number; maxQueuedRequests?: number; onceLimit?: number; encryptHistory?: boolean; pages?: Record<string, PortableRenderArtifact>; render?(next: PageResponse, context: {previous?: PageResponse; preserveLayout: boolean}): void | Promise<void>; onVersionMismatch?(next: PageResult): void | Promise<void> }
