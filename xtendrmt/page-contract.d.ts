...
export interface HeadRecord { tag: 'title' | 'meta'; text?: string; attributes?: { name?: string; property?: string; content?: string; charset?: string } }
export interface PageManifest { schema: typeof PAGE_MANIFEST_SCHEMA; version: string; configurationFingerprint?: string; assetFingerprints?: Record<string,string>; runtimeFingerprints?: {node?: Record<string,string>; php?: Record<string,string>}; assets?: { entry?: string; css?: string[] }; layouts?: Record<string, {artifact: PortableRenderArtifact; head?: HeadRecord[]}>; pages: Record<string, { artifact?: PortableRenderArtifact; input?: RmtNodeSsrRenderInput; layout?: string | null; head?: HeadRecord[] }> }
