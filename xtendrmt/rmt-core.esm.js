...
(function registerRenderManRmtFormatModule(global) {
    ...
    function attachXtendComponentEvents(element, component, deps = {}, options = {}) {
    ...
    appModules.createRmtXtendComponentAdapter = function createRmtXtendComponentAdapter(deps = {}) {
        ...
        function mountComponent(target, componentRef, model = {}, options = {}) {
            ...
            const attachedEvents = attachXtendComponentEvents(element, component, deps, options);
        ...
        return Object.freeze({
            ...
            version: DOCUMENT_VERSION,
            runtimeSurface: Object.freeze(['registerComponent', 'mountComponent', 'hydrateComponent', 'emitDiagnostic']),
            capabilities: Object.freeze({
                providedCapabilities: Object.freeze(['components', 'customElements', 'manifestLookup', 'props', 'attributes', 'slots', 'events', 'hydration', 'diagnostics', 'scheduleRefs']),
                requiredCapabilities: Object.freeze(['customElements']),
                preferredCapabilities: Object.freeze(['manifest', 'stateBridge', 'theme', 'api'])
            }),
            definition: Object.freeze({
                id: adapterId,
                kind: 'component_adapter',
