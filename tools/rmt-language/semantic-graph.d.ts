...
export declare const escapeJsonPointerSegment: RmtToolingFunction;
export declare const FABRIC_LANE_CONFLICT_CODE: RmtToolingConstant;
export declare const joinPointer: RmtToolingFunction;
export declare const REFERENCE_DIAGNOSTIC_CODES: RmtToolingConstant;
export declare const RMT_SEMANTIC_GRAPH_MODULE_PATH: RmtToolingConstant;
export declare const RMT_SEMANTIC_GRAPH_PACKAGE_SCRIPT: RmtToolingConstant;
export declare const RMT_SEMANTIC_GRAPH_REPORT_SCHEMA: RmtToolingConstant;
