...
export declare const createXtendMcpServerDefinitionConfig: RmtToolingFactory;
...
export declare const probeXtendMcpNode: RmtToolingFactory;
export declare const registerXtendMcpServerDefinitionProvider: RmtToolingFactory;
...
export declare const resolveXtendMcpServerModule: RmtToolingFactory;
...
export declare const XTEND_MCP_PROVIDER_ID: RmtToolingConstant;
