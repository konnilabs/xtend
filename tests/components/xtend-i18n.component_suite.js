...
function runXtendI18nComponentSuite(options = {}) {
  ...
  context.assertIncludes(source, 'xtend.i18n.xstate-adapter.v1', 'xtend-i18n declares xstate adapter schema');
  ...
  context.assertIncludes(source, 'xtend.i18n.locale.request', 'xtend-i18n supports xstate locale request key');
  context.assertIncludes(source, 'connectXState', 'xtend-i18n exposes xstate adapter');
  ...
  context.assertIncludes(types, 'XtendI18nXStateAdapterContract', 'xtend-i18n public types declare xstate adapter');
  ...
  context.assertIncludes(fixture, "import { xstate } from '/components/xstate.js'", 'xtend-i18n fixture imports repo-local xstate');
  ...
  context.assertIncludes(fixture, 'xtend.i18n.locale.request', 'xtend-i18n fixture covers xstate request');
