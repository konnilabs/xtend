...
function runXRmtLifecycleDemoBuildComponentSuite(options = {}) {
  ...
  context.assertIncludes(source, "const variant = this._escapeAttribute(this.getAttribute('variant') || 'default');", 'x-rmt-lifecycle-demo-build escapes variant before innerHTML interpolation');
