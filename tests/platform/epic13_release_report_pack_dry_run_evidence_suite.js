...
function runEpic13ReleaseReportPackDryRunEvidenceSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 115, 'package export lock expects 115 exports after release evidence catalog');
  context.assert(typeExportsMetadata && typeExportsMetadata.expectedExportCount === 115, 'TypeExports lock expects 115 exports after release evidence catalog');
  ...
  assertTextIncludesAll(context, packageExportContract, ['expectedExportCount: `115`', EPIC13_RELEASE_REPORT_PACK_DRY_RUN_EVIDENCE_PACKAGE_EXPORT], 'package export contract');
