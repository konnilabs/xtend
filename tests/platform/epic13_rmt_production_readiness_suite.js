...
function runEpic13RmtProductionReadinessSuite(options = {}) {
  ...
  context.assert(packageManifest.exports['./catalog/epic13-rmt-production-readiness'] === './catalog/epic13-rmt-production-readiness.js', 'Package exports RMT production readiness module');
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 60, 'Package export lock metadata includes Docs RMT hardening export');
