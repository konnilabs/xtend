...
function runEpic13RmtProductionReadinessSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 78, 'Package export lock metadata includes Docs RMT hardening export');
