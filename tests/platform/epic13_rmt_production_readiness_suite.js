...
function runEpic13RmtProductionReadinessSuite(options = {}) {
  ...
  const demoDocs = readText('docs/en/rmt-first-demo-app.md', rootDir);
  ...
  context.assert(demoSource.includes('template demo.xtend.rmtFirstApp'), 'RMT-first demo source is vNext authoring');
