...
function runEpic13Rc1GateMatrixCiHandoffSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 115, 'package export lock expects 115 exports after RC1 gate matrix and kernel catalogs');
  context.assert(typeExportsMetadata && typeExportsMetadata.expectedExportCount === 115, 'TypeExports lock expects 115 exports after RC1 gate matrix and kernel catalogs');
  ...
  assertTextIncludesAll(context, packageExportContract, ['expectedExportCount: `115`', EPIC13_RC1_GATE_MATRIX_CI_HANDOFF_PACKAGE_EXPORT], 'package export contract');
