...
function runEpic13Rc1GateMatrixCiHandoffSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount >= 124, 'package export lock expects at least 124 exports after RC1 gate matrix and kernel catalogs');
  context.assert(typeExportsMetadata && typeExportsMetadata.expectedExportCount === packageLockMetadata.expectedExportCount, 'TypeExports lock matches package export count after RC1 gate matrix and kernel catalogs');
