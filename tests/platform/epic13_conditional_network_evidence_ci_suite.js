...
function runEpic13ConditionalNetworkEvidenceCiSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 115, 'package export lock expects 115 exports after conditional network CI catalog');
  context.assert(typeExportsMetadata && typeExportsMetadata.expectedExportCount === 115, 'TypeExports lock expects 115 exports after conditional network CI catalog');
  ...
  assertTextIncludesAll(context, packageExportContract, ['expectedExportCount: `115`', EPIC13_CONDITIONAL_NETWORK_EVIDENCE_CI_PACKAGE_EXPORT], 'package export contract');
