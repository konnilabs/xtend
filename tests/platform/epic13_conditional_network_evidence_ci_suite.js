...
function runEpic13ConditionalNetworkEvidenceCiSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 124, 'package export lock expects 124 exports after conditional network CI catalog');
  context.assert(typeExportsMetadata && typeExportsMetadata.expectedExportCount === 124, 'TypeExports lock expects 124 exports after conditional network CI catalog');
  ...
  assertTextIncludesAll(context, packageExportContract, ['expectedExportCount: `124`', EPIC13_CONDITIONAL_NETWORK_EVIDENCE_CI_PACKAGE_EXPORT], 'package export contract');
