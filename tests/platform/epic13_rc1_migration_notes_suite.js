...
function runEpic13Rc1MigrationNotesSuite(options = {}) {
  ...
  const rc1ReadinessDocs = readText('development/docs-evidence/legacy-routes/en/rc1-readiness.md', rootDir);
  const ownerDocs = readText('development/docs-evidence/legacy-routes/en/release-owner-acceptance.md', rootDir);
  const trustedDomDocs = readText('docs/en/trusted-dom-boundary-browser-proof.md', rootDir);
