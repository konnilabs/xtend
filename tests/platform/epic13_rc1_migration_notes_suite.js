...
function runEpic13Rc1MigrationNotesSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 78, 'package export lock expects 78 exports after Epic 14 RMT tooling surface');
  ...
  assertTextIncludesAll(context, packageExportContract, ['expectedExportCount: `78`', './catalog/epic13-rc1-migration-notes'], 'package export contract');
