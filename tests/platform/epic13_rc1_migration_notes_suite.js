...
function runEpic13Rc1MigrationNotesSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 60, 'package export lock expects 60 exports after RC1 migration catalog');
  ...
  assertTextIncludesAll(context, packageExportContract, ['expectedExportCount: `60`', './catalog/epic13-rc1-migration-notes'], 'package export contract');
