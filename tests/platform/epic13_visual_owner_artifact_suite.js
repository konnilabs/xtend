...
function runEpic13VisualOwnerArtifactSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 115, 'Package export lock metadata includes RC1 gate matrix and kernel exports');
