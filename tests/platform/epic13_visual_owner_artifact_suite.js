...
function runEpic13VisualOwnerArtifactSuite(options = {}) {
  ...
  context.assert(packageLockMetadata && packageLockMetadata.expectedExportCount === 174, 'Package export lock metadata matches the current public export surface');
  ...
  context.assertIncludes(scaffoldConfig, 'expectedExportCount: 174', 'Scaffold config mirrors the current package export count');
