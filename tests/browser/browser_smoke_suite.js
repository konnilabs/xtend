...
function assertEpic18VendorBugfixFixtureContract(context, rootDir) {
  ...
  [
    ...
    'epic18 xplayer remote-play is event-driven',
    'epic18 xplayer remote-play normalizes audio media type',
    'epic18 xplayer keeps click and keyboard controls bound after remote-play',
    'epic18 xplayer ignores stale pause during remote source swap',
    'epic18 xplayer control handlers are single-bound after source swaps',
    'epic18 xplayer fullscreen control handles user click',
    'epic18 xplayer pauses when its surface lifecycle closes',
