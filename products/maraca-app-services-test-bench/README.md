...
Diese Anwendung ist die produktive Catfooding-Referenz für Maraca App Services in XTend 0.8.0. HTML-Host, App Shell, Runtime-Bootstrap, TypeScript-Transpilierung, Service-Manifest, Node-Host und Build-Artefakte entstehen ausschließlich über den öffentlichen XTend-/Maraca-Workflow.
