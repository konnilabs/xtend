...
try {
  ...
  if (status) status.value = ready
    ? `Maraca App Services Test Bench ready; ${surfaceCount} orchestrated surfaces.`
    : `Maraca App Services Test Bench runtime degraded; ${surfaceCount}/${Number.isSafeInteger(expectedSurfaceCount) ? expectedSurfaceCount : 0} surfaces rendered.`;
