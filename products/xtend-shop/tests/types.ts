...
const client: MaracaPageClient = createMaracaPageClient({initialPage,root:document.createElement('section')});
...
const bootstrap: Promise<MaracaPageClient> = startMaracaPageApplication({applicationKey:'test',publicKey:{kty:'EC',crv:'P-256',kid:'test'}});
