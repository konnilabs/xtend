...
foreach(['add','set','clear'] as $operation)Route::post('/cart/'.$operation,function(Request $r,Cart $cart)use($operation){$cart->change($r,$r->all(),$operation);return redirect('/warenkorb');});
