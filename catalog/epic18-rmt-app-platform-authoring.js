...
const RMT_APP_PLATFORM_AUTHORING_DOCS = 'development/docs-evidence/root/rmt-app-platform-authoring.md';
...
const RMT_APP_PLATFORM_AUTHORING_EPIC = 'development/docs-evidence/root/epic18-media-manager-vendor-upstream.md';
