...
function createEpic13Rc1MigrationNotesPlan(options = {}) {
  ...
  return {
    ...
    migrationSections: [
      createMigrationSection('loader-local-esm-cdn-free', 'xtend-loader', 'xtend-loader.js, docs/index.php, manifest policy', 'Apps with CDN-era bootstrap assumptions must switch to local ESM loader paths.', 'Use local server and same-origin ESM modules; do not load deprecated CDN xstate.'),
