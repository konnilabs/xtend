...
const RMT_COMPONENT_TEMPLATE_PRIMITIVES_DOCS = 'docs/rmt-component-template-primitives.md';
...
const RMT_COMPONENT_TEMPLATE_PRIMITIVES_EPIC = 'docs/epic18-media-manager-vendor-upstream.md';
