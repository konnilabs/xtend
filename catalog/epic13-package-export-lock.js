...
const EXPECTED_EXPORT_KEYS = Object.freeze([
  ...
  './maraca/runtime',
  './maraca/page-client',
  './maraca/page-bootstrap',
  './maraca/remote-surface',
  './maraca/plan-runtime',
  './maraca/browser-composition-runtime',
  './maraca/css-provider',
  './maraca/app-services',
  ...
  './rmt/page-client',
  './rmt/page-form',
  './rmt-language/page-build',
  './rmt/resume-runtime',
  './rmt/resume-capture-adapter',
  './rmt-language/compilation-session',
  './compiler/tooling-bridge',
  './xtensions/host-controller-contract',
  './xtensions/resume-adapter-contract',
...
const SURFACE_GROUPS = Object.freeze([
  ...
  {
    id: 'maraca',
    requiredExports: ['./maraca', './maraca/runtime', './maraca/plan-runtime', './maraca/browser-composition-runtime', './maraca/css-provider', './maraca/app-services', './maraca/server-services', './maraca/node-app-service-host', './maraca/service-build-provider'],
