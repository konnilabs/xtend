...
export declare const RMT_KERNEL_POLICY_PARITY_LOCAL_GATE: string;
export declare const RMT_KERNEL_POLICY_PARITY_PACKAGE_SCRIPT: string;
export declare const RMT_KERNEL_POLICY_PARITY_REPORT_SCHEMA: string;
export declare const RMT_KERNEL_POLICY_PARITY_REQUIRED_FACTORIES: readonly XtendCatalogConstant[] | XtendCatalogConstant;
export declare const RMT_KERNEL_POLICY_PARITY_SCHEMA: string;
