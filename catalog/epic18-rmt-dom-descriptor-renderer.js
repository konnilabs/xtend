...
const RMT_DOM_DESCRIPTOR_RENDERER_DOCS = 'docs/rmt-dom-descriptor-renderer.md';
...
const RMT_DOM_DESCRIPTOR_RENDERER_EPIC = 'docs/epic18-media-manager-vendor-upstream.md';
